(function () {
  ...
  angular
    ...
    .controller('ComProjectDetailAdminController', ComProjectDetailAdminController);

  ComProjectDetailAdminController.$inject = ['$scope', '$stateParams', 'ComProjectApi', '$filter'];

  function ComProjectDetailAdminController($scope, $stateParams, ComProjectApi, $filter) {
    var vm = this;
