(function () {
  ...
  var multiselect = angular.module('core');
  ...
  multiselect.directive('multiselect', function ($filter, $document, $log) {
    return {
      ...
      require: 'ngModel',
      templateUrl: '/modules/core/client/views/template/multiselect.client.view.html',
      ...
      link: function ($scope, $element, $attrs, $ngModelCtrl) {
        ...
        if ($scope.optionDefault) {
          $scope.options = [$scope.optionDefault].concat($scope.options);
        }
        $scope.searchFilter = '';
