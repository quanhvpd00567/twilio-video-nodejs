...
var initGlobalConfigFiles = function (config, assets) {
  ...
  // Setting Globbed mobile route files

  config.files.mobile.routes = getGlobbedPaths(assets.server.m_routes);

  // Setting Globbed mobile config files
  config.files.mobile.configs = getGlobbedPaths(assets.server.m_config);

  // Setting Globbed mobile socket files
  config.files.mobile.sockets = getGlobbedPaths(assets.server.m_sockets);

  // Setting Globbed policies files
  config.files.mobile.policies = getGlobbedPaths(assets.server.m_policies);
};
