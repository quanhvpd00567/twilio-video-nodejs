...
module.exports.initModulesConfiguration = function (app) {
  ...
  config.files.mobile.configs.forEach(function (configPath) {
    require(path.resolve(configPath))(app);
  });
};
...
module.exports.initModulesServerPolicies = function (app) {
  ...
  config.files.mobile.policies.forEach(function (policyPath) {
    require(path.resolve(policyPath)).invokeRolesPolicies();
  });
};
...
module.exports.initModulesServerRoutes = function (app) {
  ...
  config.files.mobile.routes.forEach(function (routePath) {
    require(path.resolve(routePath))(app);
  });
};
