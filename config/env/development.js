...
module.exports = {
  db: {
    uri: process.env.MONGOHQ_URL || process.env.MONGODB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || '127.0.0.1:27017') + '/astena-mft-dev',
    options: {},
  ...
  mailer: {
    ...
    options: {
      ...
      auth: {
        ...
        user: process.env.MAILER_EMAIL_ID || 'nongtruong157@gmail.com',
        // pass: process.env.MAILER_PASSWORD || 'Hung1996'
        pass: process.env.MAILER_PASSWORD || 'stzsghpcrcemwbjb'
      }
    }
  },
  livereload: false,
